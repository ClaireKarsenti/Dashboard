...
export const addUser = async (formData: any) => {
  ...
  try {
    ...
    console.log(err);
    throw new Error('❗️Failed to create user!');
  }
...
export const deleteUser = async (formData: any) => {
  ...
  try {
    ...
    console.log(err);
    throw new Error('❗️Failed to delete user!');
  }
...
export const addProduct = async (formData: any) => {
  ...
  try {
    ...
    console.log(err);
    throw new Error('❗️Failed to create product!');
  }
...
export const deleteProduct = async (formData: any) => {
  ...
  try {
    ...
    console.log(err);
    throw new Error('❗️Failed to delete product!');
  }
